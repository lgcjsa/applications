...
public class MailWithAttachmentLM extends Mail {
	...
	public void sendTo(String to, String testo) {
		...
		try {
			...
			msg.setFrom(new InternetAddress(Mail.smtp));
	...
	public void sendTo(String to) {
		...
		// Get system properties
		 ...
		 // Setup mail server
		 props.put("mail.smtp.host", super.smtp);
		 ...
		 message.setFrom(new InternetAddress(super.smtp));
		 ...
		 messageBodyPart.setContent(this.getTesto(), "text/html");
		 // Add the first part
