 ...
 * @see luiss.it.LGCDB_Clienti.dao.MiurScuole
...
public class MiurScuoleHome {
	...
	public List findByExample(MiurScuole instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("luiss.it.LGCDB_Clienti.dao.MiurScuole")
