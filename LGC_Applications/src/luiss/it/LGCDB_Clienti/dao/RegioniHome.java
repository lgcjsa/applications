 ...
 * @see luiss.it.LGCDB_Clienti.dao.Regioni
...
public class RegioniHome {
	...
	public Regioni findById(java.lang.Integer id) {
		...
		try {
			Regioni instance = (Regioni) sessionFactory.getCurrentSession().get("luiss.it.LGCDB_Clienti.dao.Regioni",
					id);
			if (instance == null) {
	...
	public List findByExample(Regioni instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("luiss.it.LGCDB_Clienti.dao.Regioni")
