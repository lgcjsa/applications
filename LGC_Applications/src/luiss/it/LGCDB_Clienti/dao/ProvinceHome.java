 ...
 * @see luiss.it.LGCDB_Clienti.dao.Province
...
public class ProvinceHome {
	...
	public Province findById(java.lang.Integer id) {
		...
		try {
			Province instance = (Province) sessionFactory.getCurrentSession().get("luiss.it.LGCDB_Clienti.dao.Province",
					id);
			if (instance == null) {
	...
	public List findByExample(Province instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("luiss.it.LGCDB_Clienti.dao.Province")
