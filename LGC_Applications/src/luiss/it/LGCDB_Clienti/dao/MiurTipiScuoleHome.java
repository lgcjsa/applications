 ...
 * @see luiss.it.LGCDB_Clienti.dao.MiurTipiScuole
	...
	public MiurTipiScuole findById(java.lang.String id) {
		...
		try {
			MiurTipiScuole instance = (MiurTipiScuole) sessionFactory.getCurrentSession()
					.get("luiss.it.LGCDB_Clienti.dao.MiurTipiScuole", id);
			if (instance == null) {
	...
	public List findByExample(MiurTipiScuole instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("luiss.it.LGCDB_Clienti.dao.MiurTipiScuole").add(Example.create(instance)).list();
